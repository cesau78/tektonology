    ...
    <RequireRole roles={["owner", "auditor"]}>
      <div>
        <nav className="flex items-center gap-2 text-sm text-muted-foreground mb-6">
          ...
          <span>›</span>
          <Link href="/finance/accounts" className="hover:text-foreground transition-colors">
            Chart of Accounts
          </Link>
          <span>›</span>
          ...
          <>
            <div className="mb-6">
              ...
              <p className="text-muted-foreground text-sm">
                Balance:{" "}
                <span className="font-mono font-semibold text-foreground">{fmt(account.balance)}</span>
              </p>
            </div>
