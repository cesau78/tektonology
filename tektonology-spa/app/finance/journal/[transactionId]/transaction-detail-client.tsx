    ...
    <RequireRole roles={["owner", "auditor"]}>
      <div>
        <nav className="flex items-center gap-2 text-sm text-muted-foreground mb-6">
          ...
          <span>›</span>
          <Link href="/finance" className="hover:text-foreground transition-colors">
            Finance
          </Link>
          <span>›</span>
          <Link href="/finance/journal" className="hover:text-foreground transition-colors">
            Journal
          </Link>
          <span>›</span>
            ...
            <CardContent>
              ...
              <div className="mt-3 flex items-center gap-4 text-sm border-t pt-2">
                <span className="text-muted-foreground">
                  Total Debits: <span className="font-mono font-semibold">{fmt(dr)}</span>
                </span>
                <span className="text-muted-foreground">
                  Total Credits: <span className="font-mono font-semibold">{fmt(cr)}</span>
                </span>
              </div>
            </CardContent>
          </Card>
